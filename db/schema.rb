...
ActiveRecord::Schema[7.0].define(version: 2022_11_07_003939) do
  ...
  create_table "abilities", force: :cascade do |t|
    ...
    t.integer "cooldown_timer_delay", default: 0
  ...
  create_table "effects", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ability_id"], name: "index_effects_on_ability_id"
  end
  ...
  add_foreign_key "effects", "abilities"
